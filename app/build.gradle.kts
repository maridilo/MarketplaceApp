...
dependencies {
    ...
    // 1. Room (Base de Datos) - Versión para Java
    val roomVersion = "2.6.1"
    implementation("androidx.room:room-runtime:$roomVersion")
    annotationProcessor("androidx.room:room-compiler:$roomVersion") // Java usa annotationProcessor
    ...
    // 4. Firebase (BoM controla las versiones)
